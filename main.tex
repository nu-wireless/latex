...
\author{
  ...
  {\small Muhammad Elarbi, Robert Halpern}
  }
...
\section{What is \LaTeX{}? \textit{(The What)}}
% =============================================================================
% Slide: What is LaTeX
% =============================================================================
\begin{frame}{What is \LaTeX{}}
  \begin{block}{Pronunciation\footnotesize\footnotemark}
    \centering
    \large \textbf{``Lah-tech" or ``Lay-tech"}
  \end{block}
  \footnotetext{\url{https://www.latex-project.org/about/}}
  \begin{itemize}
    \item<2-> A typesetting system.
    \item<3-> Based on plain text and compiled into PDFs.
    \item<4-> Especially powerful for complex formatting, math, citations, figures, and \textit{code}.
    \item<5-> Common in academia, research, and publishing - many professors encourage it!
  \end{itemize}
  \onslide<6->{
...
\section{Why use \LaTeX{}? \textit{(The Why)}}
% =============================================================================
...
\begin{frame}{Real-World Applications of \LaTeX}
  \only<1>{
    \begin{itemize}
      \item R\'esum\'es and CVs
      \item Lab reports
      \item Typesetting your class notes (more on this in the next slide)
      \item Exam cheat sheets
      \item Technical documentation
      \item Research papers, journal articles
      \item Thesis/dissertation formatting
      \item Chechecklists, Bills of Materials (BOMs), and similar documents
      \item Slide decks, like this one (\LaTeX\ Beamer)!
    \end{itemize}
    }
    
  \only<2>{
    When people talk about typesetting class notes in \LaTeX, it usually falls into two categories:
    \begin{enumerate}
      \item Taking notes in \LaTeX\ \textbf{in real time} during lecture, or
      \item Taking notes in a notebook or word processor and typesetting them after class
    \end{enumerate}
    The second option is far more common because real-time note-taking is extremely difficult, even for experienced \LaTeX\ users. However, it \textit{is} possible.
    A \href{https://www.quora.com/Does-anybody-use-LaTeX-to-take-notes-especially-during-class-If-not-what-do-you-use-especially-when-you-need-to-write-down-equations/answer/Gilles-Castel-1}{Quora question}, answered by Gilles Castel:
    \begin{quote}
      \textit{Can people actually keep up with note-taking in mathematics lectures with \LaTeX?}
    \end{quote}
    led to an article in which he describes his real-time workflow, noting:
    \begin{quote}
      “These lecture notes — including figures — are made while attending the lecture and have not been edited afterwards.”
    \end{quote}
    Full article: \url{https://castel.dev/post/lecture-notes-1/}
  }
\end{frame}

\section{Writing and Compiling \LaTeX{} \textit{(The How)}}
% =============================================================================
...
\section{Helpful Resources \& Tips}
% =============================================================================
...
\begin{frame}{Final Thoughts}
    ...
    \end{itemize}
    \begin{center}
      \large This entire slide deck was compiled locally using \LaTeX\ (Beamer)!
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \href{mailto:halpern.ro@northeastern.edu}{halpern.ro}}[at]northeastern[d0t]edu
