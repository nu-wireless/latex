...
\begin{itemize}
    \item<1-> A typesetting system.
    \item<2-> Based on plain text and compiled into PDFs.
    \item<3-> Especially powerful for complex formatting, math, citations, figures, and \textit{code}.
    \item<4-> Common in academia, research, and publishing - many professors encourage it!
\end{itemize}
